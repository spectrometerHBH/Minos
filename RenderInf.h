...
class RenderInfNode {
 public:
  ...
  static char* serialize(char* buffer, size_t value);
  static char* serialize(char* buffer, Ogre::uint32 value);
  ...
  static const char* deserialize(const char* buffer, size_t& value);
  static const char* deserialize(const char* buffer, Ogre::uint32& value);
  static const char* deserialize(const char* buffer, Ogre::Vector3& value);
  static const char* deserialize(const char* buffer, Ogre::Quaternion& value);
  static const char* deserialize(const char* buffer, Ogre::Matrix4& value);
  template <typename T>
